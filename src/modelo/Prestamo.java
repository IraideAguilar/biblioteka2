...
public class Prestamo {
	...
	private Date fecha;
	private boolean devuelto; // devuelto true y sino es devuelto false
	...
	public void mostrarInfo(){
		...
		SimpleDateFormat formato = new SimpleDateFormat("yyyy-MM-dd");//La clase SimpleDateFormat nos ayuda a mostrar las fechas en el formato que queramos o a reconstruirlas a partir de una cadena de texto.
